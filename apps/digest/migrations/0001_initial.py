    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, max_length=500, null=True, verbose_name='URL источника')),
                ('source_type', models.CharField(choices=[('rss', 'RSS лента'), ('google', 'Google Search'), ('manual', 'Ручной ввод')], max_length=20, verbose_name='Тип источника')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enable_google_news', models.BooleanField(default=False, verbose_name='Включить Google News')),
                ('enable_rss_news', models.BooleanField(default=True, verbose_name='Включить RSS')),
        ...
        migrations.AddIndex(
            model_name='articlesource',
            index=models.Index(fields=['source_type', 'is_active'], name='digest_arti_source__eece00_idx'),
        ),
    ]
