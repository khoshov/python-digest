...
class FilterService:
    ...
    def check_relevance_with_flowise(self, article: Dict[str, str], flow_id: str, flowise_host: str) -> Dict[str, any]:
    ...
    def filter_news_with_flowise(self, articles: List[Dict[str, str]],
                                flow_id: str,
        ...
        for article in articles:
            relevance_check = self.check_relevance_with_flowise(article, flow_id, flowise_host)
    ...
    def get_all_articles_with_filter_results(self, articles: List[Dict[str, str]],
                                            flow_id: str,
                                            flowise_host: str) -> List[Dict[str, str]]:
        """
