...
def find_duplicates(articles: List[Dict[str, str]],
    ...
    for article in articles:
        ...
        if check_content and unique_articles:
            for existing_article in unique_articles:
                ...
                title_similarity = calculate_content_similarity(
...
def deduplicate_articles(articles: List[Dict[str, str]],
                        similarity_threshold: float = 0.85,
                        check_content: bool = True) -> List[Dict[str, str]]:
    """
    ...
    unique_articles = find_duplicates(
        articles=articles,
